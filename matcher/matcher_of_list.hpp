#ifndef __PARSER_MATCHER_MATCHER_OF_LIST_HPP__
#define __PARSER_MATCHER_MATCHER_OF_LIST_HPP__
...
class list_matcher : public abstract_matcher_operation
{
    std::list<char> m_pattern;

public:
    list_matcher(const std::list<char>&);
...
#endif	/* __PARSER_MATCHER_MATCHER_OF_LIST_HPP__ */
